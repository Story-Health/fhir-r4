...
import { ISpecimen_Collection } from "./Specimen_Collection";
import { ISpecimen_Container } from "./Specimen_Container";
import { ISpecimen_Processing } from "./Specimen_Processing";

export enum SpecimenStatusKind {
  _available = "available",
  _unavailable = "unavailable",
  _unsatisfactory = "unsatisfactory",
