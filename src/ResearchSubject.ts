...
export enum ResearchSubjectStatusKind {
  ...
  _notRegistered = "not-registered",
  _offStudy = "off-study",
  _onStudy = "on-study",
  _onStudyIntervention = "on-study-intervention",
  _onStudyObservation = "on-study-observation",
  _pendingOnStudy = "pending-on-study",
  _potentialCandidate = "potential-candidate",
