...
import { ISubstancePolymer_MonomerSet } from "./SubstancePolymer_MonomerSet";
import { ISubstancePolymer_Repeat } from "./SubstancePolymer_Repeat";
...
Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
   ...
   * Todo.
   */
  monomerSet?: ISubstancePolymer_MonomerSet[];

  /**
   * Todo.
   */
  repeat?: ISubstancePolymer_Repeat[];
}
