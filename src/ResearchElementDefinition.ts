...
import { IResearchElementDefinition_Characteristic } from "./ResearchElementDefinition_Characteristic";
import { IResourceList } from "./ResourceList";
import { IUsageContext } from "./UsageContext";

export enum ResearchElementDefinitionStatusKind {
  _draft = "draft",
  _active = "active",
  _retired = "retired",
  _unknown = "unknown",
}
export enum ResearchElementDefinitionTypeKind {
  _population = "population",
  _exposure = "exposure",
  _outcome = "outcome",
}
export enum ResearchElementDefinitionVariableTypeKind {
...
export interface IResearchElementDefinition extends IDomainResource {
   ...
   */
  characteristic: IResearchElementDefinition_Characteristic[];
...
Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
   ...
   */
  status?: ResearchElementDefinitionStatusKind;
   ...
   */
  type?: ResearchElementDefinitionTypeKind;
   ...
   */
  variableType?: ResearchElementDefinitionVariableTypeKind;
